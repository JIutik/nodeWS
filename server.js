            ...
            "messages": [
              {
                ...
                "quote": {
                  ...
                  "text": "Ваши документы приняты и зарегистрированы. После финального заключения договора вам будет доступен зарплатный проект.",
                  "authorName": "Евгений"
                }
              },
              {
              ...
              },
              {
                ...
                "userType": "CUSTOMER",
                "text": "Хорошо, я сейчас подготовлю и направлю документы",
                "messageStatus": "messageRead",
                "quote": {
                  "messageId": "c90e34e3-c1e3-4ae7-bf22-e11531003e3f",
                  "text": "Здравствуйте! Для подключения зарплатного проекта, Вам необходимо предоставить документ 1,2,3. После этого, мы сможем заключить договор и подключить услугу.",
                  "authorName": "Евгений"
                }
              },
              {
                ...
                "quote": {
                  ...
                  "text": "Добрый день! Какие документы необходимо предоставить для подключения зарплатного проекта?"
                }
              },
              {
                "messageId": "c22da6c0-40f3-4794-8153-e68f092c74a8",
                          ...
                          "messages": [
                            {
                              ...
                              "userType": "CUSTOMER",
                              "text": "Спасибо! Все отлично, мой платеж прошел!",
                              "messageStatus": "messageRead",
                              "quote": {
                                "messageId": "ecd7d127-ef93-47a5-8835-380e1c98325d",
                                "text": "Уважаемый клиент, я занимаюсь вашим вопросом, повторите платеж через несколько минут",
                                "authorName": "Дмитрий"
                              }
                            },
                            {
                            ...
                            },
                            {
                              ...
                              "userType": "CUSTOMER",
                              "text": "Здравствуйте! У меня есть вопрос по платежам",
                              "messageStatus": "messageRead"
                            }
                          ]
                        }
